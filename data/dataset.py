...
def get_splite_data():
    ...
    """取出标签"""
    y = [0] * config.train_pos + [1] * config.train_neg
    y = np.array(y)
...
def get_splite_data2():
    ...
    total=config.train_pos+config.train_neg
...
def get_testset():
    ...
    """取出标签"""
    y = [0] * config.test_pos + [1] * config.test_neg
    y = np.array(y)
