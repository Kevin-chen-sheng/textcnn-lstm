...
def create_model(optimizer='adam',n_filter=100,kernel_size=3,mp_size=2,dense_num=200,activation_f='relu'):
    model=Sequential()
...
# acc=duliceshi(dataset,dataset1,Y,TY)
# print(acc)
...
np.savetxt('cv_predlstm02.csv',np.array([test_labels,test_pred,test_pro01]).T,delimiter=',',fmt='%s')
